...
type DraftPickServiceClient interface {
	GetPlayers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*player_proto.Players, error)
}
...
func (c *draftPickServiceClient) GetPlayers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*player_proto.Players, error) {
	out := new(player_proto.Players)
	err := c.cc.Invoke(ctx, "/adp_server.DraftPickService/GetPlayers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DraftPickServiceServer interface {
	GetPlayers(context.Context, *emptypb.Empty) (*player_proto.Players, error)
...
func (UnimplementedDraftPickServiceServer) GetPlayers(context.Context, *emptypb.Empty) (*player_proto.Players, error) {
...
func _DraftPickService_GetPlayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/adp_server.DraftPickService/GetPlayers",
	}
...
var DraftPickService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "adp_server.DraftPickService",
